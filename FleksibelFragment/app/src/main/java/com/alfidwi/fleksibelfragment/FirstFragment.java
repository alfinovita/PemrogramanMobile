package com.alfidwi.fleksibelfragment;
...
public class FirstFragment extends Fragment implements View.OnClickListener{
    ...
    //Method yang sama dengan nama kelas = konstruktor
        ...
        if(v.getId() == R.id.firstButton){
            ...
            if(mFragmentManager != null){
                mFragmentManager
                        ...
                        .addToBackStack(null)//kembali ke hal sebelumnya agar tidak keluar aplikasi
                        .commit();
            }
        }
    }
